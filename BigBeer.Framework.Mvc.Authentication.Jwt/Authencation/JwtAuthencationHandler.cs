...
{
    public class JwtAuthencationHandler : AuthenticationHandler<JwtAuthencationOptions>
    {
        private OpenIdConnectConfiguration _configuration;

        public JwtAuthencationHandler(IOptionsMonitor<JwtAuthencationOptions> options, ILoggerFactory logger, UrlEncoder encoder, IDataProtectionProvider dataProtection, ISystemClock clock)
