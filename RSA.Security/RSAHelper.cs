...
namespace RSA.Security
{
    public class RSAHelper
    {
        ...
        public RSAHelper(RSAType rsaType = RSAType.RSA2, Encoding encoding =null, string privateKey =null, string publicKey = null)
        {
            if (encoding == null)
            {
            ...
            _encoding = encoding;
            _privateKeyRsaProvider = CreateRsaProviderFromPrivateKey(Statikey.PrivateKey);
            _publicKeyRsaProvider = CreateRsaProviderFromPublicKey(Statikey.PublicKey);
